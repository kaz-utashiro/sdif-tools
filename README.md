[![Build Status](https://travis-ci.org/kaz-utashiro/sdif-tools.svg?branch=master)](https://travis-ci.org/kaz-utashiro/sdif-tools) [![MetaCPAN Release](https://badge.fury.io/pl/App-sdif.svg)](https://metacpan.org/release/App-sdif)
# NAME
